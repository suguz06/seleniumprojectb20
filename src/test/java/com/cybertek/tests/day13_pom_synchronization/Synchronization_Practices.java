...
public class Synchronization_Practices {
    ...
    public void p40_dynamic_title_test(){
       ...
       //creating object to be able to use webelement
        Loading7Page loading7Page=new Loading7Page();


      //to create explicit wait until the title changes
        WebDriverWait wait=new WebDriverWait(Driver.getDriver(), 10);

      //we need to use   webDriverWait object to SETUP OUR EXPECTED CONDITION

        wait.until(ExpectedConditions.titleIs("Dynamic title"));

// there are many cases for  ExpectedConditions =>>

      //  BrowserUtil.wait(6);
        boolean displayed = loading7Page.doneMessage.isDisplayed();
